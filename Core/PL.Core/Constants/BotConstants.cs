namespace PL.Core.Constants
{
	public static class BotConstants
	{
		...
		public const int EATING_ENERGY_LOSES = 10;
		public const int IGNORING_ENERGY_LOSES = 3;
		public const int ROTATION_ENERGY_LOSES = 5;
		public const int BIRTH_ENERGY_LOSES = 50;

		public const int PHOTOSYNTHESIZE_ENERGY_ADD = 7;
	}
}
